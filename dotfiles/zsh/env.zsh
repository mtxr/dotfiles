...
export PATH="$WORKSTATION/bin:$HOME/.yarn/bin:$N_PREFIX/bin:$HOME/.local/bin:$GOPATH/bin:/home/linuxbrew/.linuxbrew/bin:/home/linuxbrew/.linuxbrew/sbin:$HOME/bin:/snap/bin:/usr/local/sbin:/sbin:$PATH"
