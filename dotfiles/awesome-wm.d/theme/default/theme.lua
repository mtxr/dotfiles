...
theme.dir           = os.getenv("HOME") .. "/.config/awesome/theme/default"
theme.font_base     = "Liberation Mono"
theme.font          = theme.font_base .. " 8"
theme.notification_font = theme.font_base .. " 9"
...
theme.fg_muted      = xrdb.color8
theme.critical      = xrdb.color1
theme.warning       = xrdb.color3
theme.attention     = xrdb.color4
theme.ok            = xrdb.color2
theme.xrdb          = xrdb
...
theme.panel_height = theme.menu_height
return theme
